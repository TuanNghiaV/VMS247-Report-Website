...
export const HardwareTabs: React.FC<HardwareTabsProps> = ({
  ...
  return (
    <div className="mb-2.5 flex flex-wrap gap-1.5 overflow-x-auto pb-0.5" data-section-nav-ignore="true">
      {groups.map((group) => {
        ...
        return (
          <button
            ...
            className={cn(
              "inline-flex items-center gap-1.5 rounded-[var(--radius-pill)] border px-3.5 py-1.5 text-xs font-semibold transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus-ring)]",
              active
